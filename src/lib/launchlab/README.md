# LaunchLab (retired app — algorithms kept for porting)

> This documents the original standalone LaunchLab prototype, whose app layer
> was retired when the work merged onto the IdeateX base. Only the algorithm
> files in this directory survive. Commands, pages, and stack details below
> describe the retired app and do not apply to this repo.
